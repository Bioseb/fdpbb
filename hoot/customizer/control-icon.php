	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'icon' :
				...
				<div class="hoot-customizer-control-icon-picked hoot-flypanel-button" data-flypaneltype="icon"><i class="<?php echo esc_attr( $iconvalue ) ?>"></i><span><?php _e( 'Select Icon', 'dispatch-premium' ) ?></span></div>
				<div class="hoot-customizer-control-icon-remove"><i class="fas fa-ban"></i><span><?php _e( 'Remove Icon', 'dispatch-premium' ) ?></span></div>
	...
	<div id="hoot-flyicon" class="hoot-flypanel">
		<div class="hoot-flypanel-header hoot-flypanel-nav">
			<div class="primary-actions">
				<span class="hoot-flypanel-back" tabindex="-1"><span class="screen-reader-text"><?php _e( 'Back', 'dispatch-premium' ) ?></span></span>
			</div>
		</div>
