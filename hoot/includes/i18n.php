...
/* Overrides the load textdomain function for the 'dispatch-premium' domain. */
...
/**
 * Overrides the load textdomain functionality when 'dispatch-premium' is the domain in use. The purpose of 
 * this is to allow theme translations to handle the framework's strings. What this function does is 
 * sets the 'dispatch-premium' domain's translations to the theme's. That way, we're not loading multiple 
...
function hoot_override_load_textdomain( $override, $domain, $mofile ) {
	...
	$text_domains = array( 'dispatch-premium' );
