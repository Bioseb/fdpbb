...
function hoot_attachment_id3_keys( $fields, $attachment, $context ) {
	...
	if ( 'display' === $context ) {
		...
		$fields['filesize']		 = __( 'File Size', 'dispatch-premium' );
		$fields['mime_type']		= __( 'Mime Type', 'dispatch-premium' );
		$fields['length_formatted'] = __( 'Run Time',  'dispatch-premium' );
	}

	if ( hoot_attachment_is_audio( $attachment->ID ) ) {

		$fields['genre']		= __( 'Genre',	'dispatch-premium' );
		$fields['year']		 = __( 'Year',	 'dispatch-premium' );
		$fields['composer']	 = __( 'Composer', 'dispatch-premium' );
		$fields['track_number'] = __( 'Track',	'dispatch-premium' );

		if ( 'display' === $context )
			$fields['unsynchronised_lyric'] = __( 'Lyrics', 'dispatch-premium' );
	}
