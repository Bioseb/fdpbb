...
if ( has_nav_menu( 'primary' ) ) : // Check if there's a menu assigned to the 'primary' location.
	...
	?>
	<h3 class="screen-reader-text"><?php _e( 'Primary Navigation Menu', 'dispatch-premium' ); ?></h3>
	<nav <?php hoot_attr( 'menu', 'primary' ); ?>>
		<div class="menu-toggle"><span class="menu-toggle-text"><?php _e( 'Menu', 'dispatch-premium' ); ?></span><i class="fas fa-bars"></i></div>
