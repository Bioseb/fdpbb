...
$searchlabel = apply_filters( 'hoot_search_form_label', __( 'Search', 'dispatch-premium' ) );
$searchplaceholder = apply_filters( 'hoot_search_form_placeholder', __( 'Type Search Term &hellip;', 'dispatch-premium' ) );
$searchsubmit = apply_filters( 'hoot_search_form_submit', __( 'Search', 'dispatch-premium' ) );
