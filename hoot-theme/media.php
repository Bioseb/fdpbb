...
function hoot_theme_custom_image_sizes( $sizes ) {
	$sizes = array(
		...
		'hoot-small-preview' => array(
			'label'          => __( 'Small Preview', 'dispatch-premium' ),
			'width'          => 315,
			'height'         => 230,
			'crop'           => true,
		...
		'hoot-large-preview' => array(
			'label'          => __( 'Large Preview', 'dispatch-premium' ),
			'width'          => 420,
			'height'         => 190,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-medium-preview' => array(
			'label'          => __( 'Medium Preview', 'dispatch-premium' ),
			'width'          => 425,
			'height'         => 550,
			'crop'           => false,
			'show_in_editor' => false,
		...
		'hoot-wide' => array(
			'label'          => __( 'Wide', 'dispatch-premium' ),
			'width'          => 840,
			'height'         => 385,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-extra-wide' => array(
			'label'          => __( 'Extra Wide', 'dispatch-premium' ),
			'width'          => 945,
			'height'         => 385,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-boxcontent' => array(
			'label'          => __( 'Boxcontent Image', 'dispatch-premium' ),
			'width'          => 520,
			'height'         => 480,
			'crop'           => true,
			'show_in_editor' => false,
