...
class Hoot_Social_Icons_Widget extends Hoot_WP_Widget {
	...
	function __construct() {
		...
		$settings['name'] = __( 'Hoot > Social Icons', 'dispatch-premium' );
		$settings['widget_options'] = array(
			'description'	=> __('Display Social Icons', 'dispatch-premium'),
		...
		$settings['form_options'] = array(
			...
			array(
				'name'		=> __( 'Social Icons', 'dispatch-premium' ),
				'id'		=> 'icons',
				'type'		=> 'group',
				'options'	=> array(
					'item_name'	=> __( 'Icon', 'dispatch-premium' ),
				),
				'fields'	=> array(
					array(
						'name'		=> __( 'Social Icon', 'dispatch-premium' ),
						'id'		=> 'icon',
						'type'		=> 'select',
