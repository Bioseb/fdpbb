...
class Hoot_Content_Posts_Blocks_Widget extends Hoot_WP_Widget {
	...
	function __construct() {
		...
		$settings['name'] = __( 'Hoot > Content Blocks (Posts)', 'dispatch-premium' );
		...
		$settings['form_options'] = array(
			...
			array(
				'name'		=> __( 'Category (Optional)', 'dispatch-premium' ),
			...
			array(
				...
				'desc'		=> __( 'Default: 4', 'dispatch-premium' ),
				'id'		=> 'count',
				'type'		=> 'text',
			...
			array(
				'name'		=> __( 'Offset', 'dispatch-premium' ),
				'desc'		=> __( 'Number of posts to skip from the start. Leave empty to start from the latest post.', 'dispatch-premium' ),
				'id'		=> 'offset',
				'type'		=> 'text',
				'settings'	=> array( 'size' => 3, ),
				'sanitize'	=> 'absint',
			...
			array(
				'name'		=> __( 'Show Author', 'dispatch-premium' ),
				'id'		=> 'show_author',
				'type'		=> 'checkbox',
			),
			array(
				'name'		=> __( 'Show Post Date', 'dispatch-premium' ),
				'id'		=> 'show_date',
				'type'		=> 'checkbox',
			),
			array(
				'name'		=> __( 'Show number of comments', 'dispatch-premium' ),
				'id'		=> 'show_comments',
				'type'		=> 'checkbox',
			),
			array(
				'name'		=> __( 'Show categories', 'dispatch-premium' ),
				'id'		=> 'show_cats',
				'type'		=> 'checkbox',
			),
			array(
				'name'		=> __( 'Show tags', 'dispatch-premium' ),
				'id'		=> 'show_tags',
				'type'		=> 'checkbox',
			),
			array(
