...
function hoot_appearance_subpage() {
	...
	add_theme_page(
		__( 'Dispatch Premium', 'dispatch-premium' ),	// Page Title
		__( 'Premium Options', 'dispatch-premium' ),	// Menu Title
...
function hoot_theme_appearance_subpage() {
	...
	$hoot_cta = ( empty( $hoot_cta ) ) ? '<a class="button button-primary button-buy-premium" href="https://wphoot.com/" target="_blank">' . __( 'Click here', 'dispatch-premium' ) . '</a>' : $hoot_cta;
	...
	$hoot_intro = wp_parse_args( $hoot_intro, array(
		'name' => __('Upgrade to Premium', 'dispatch-premium'),
		'desc' => '',
		) );
	?>
