...
final class Hoot_Migration {
	...
	public function notice() {
		...
		<div class="notice notice-warning hoot-migration-notice is-dismissible" >
			<p><?php printf( __( 'Thank you for updating the theme. This version uses the new Hoot 2.0 framework.<br />You will find substantial changes in the new theme. %sClick here%s for support regarding migration to the new version.', 'dispatch-premium' ), '<a href="'.$migration_doc.'">', '</a>' ); ?></p><p><a href="#" class="notice-dismiss button hoot-notice-dismiss"><?php _e( 'Dismiss', 'dispatch-premium' ); ?></a></p>
		</div>
		<?php
	}
