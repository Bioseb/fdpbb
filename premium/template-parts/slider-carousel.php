			...
			<li class="lightSlide hootslider-carousel-slide hootslider-carousel-slide-<?php echo $slide_count; $slide_count++; ?>">
				<div class="lightSlideCarousel">
					...
					<?php if ( !empty( $slide['image'] ) ) { ?>
						<div class="hootslider-carousel-slide-image">
							<?php if ( !empty( $slide['url'] ) )
								echo '<a href="' . esc_url( $slide['url'] ) . '" ' . hoot_get_attr( 'hootslider-carousel-slide-link' ) . '>'; ?>
							...
							if ( !empty( $imageid ) )
								echo wp_get_attachment_image( $imageid, apply_filters( 'hoot_carouselslider_imgsize', 'hoot-medium-preview' ), '', array( 'class' => 'hootslider-carousel-slide-img' ) );
							else
					...
					<?php if ( !empty( $slide['content'] ) ) { ?>
						<div <?php hoot_attr( 'hootslider-carousel-slide-content', '', 'linkstyle' ); ?>>
