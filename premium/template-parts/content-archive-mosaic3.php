...
<article <?php hoot_attr( 'post', '', 'archive-mosaic archive-mosaic3 hgrid-span-4' ); ?>>

	<div class="entry-grid hgrid">

		<?php if ( has_post_thumbnail() ) : ?>
			<?php $img_size = apply_filters( 'hoot_post_image_archive_mosaic3', 'hoot-small-preview' );
		...
		<div class="entry-grid-content">
			...
			<div class="mosaic-sub">
				<?php if ( is_sticky() ) : ?>
					<div class="entry-sticky-tag contrast-typo"><?php _e( 'Sticky', 'dispatch-premium' ) ?></div>
				<?php endif; ?>
