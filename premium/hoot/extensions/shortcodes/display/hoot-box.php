...
if ( !empty( $boxicon ) ) $boxicon = "<div class='shortcode-box-icon table-cell-mid'><i class='" . hoot_sanitize_fa( $boxicon ) . "'></i></div>";
$style = '';
if ( !empty( $background ) ) $style .= " background: " . hoot_color_santize_hex( $background ) . ";";
if ( !empty( $text ) )       $style .= " color: " . hoot_color_santize_hex( $text ) . ";";
