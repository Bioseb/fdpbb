...
class Hoot_Shortcodes {
	...
	public function __construct() {
		...
		require_once( trailingslashit( HOOT_PREMIUM_EXTENSIONS ) . 'shortcodes/helpers.php' );
		...
		if ( is_admin() ) :
			...
			require_once( trailingslashit( HOOT_PREMIUM_EXTENSIONS ) . 'shortcodes/admin.php' );
	...
	public static function get_shortcodes_array() {
		...
		if ( !$shortcodes ) {
			...
			if ( file_exists( trailingslashit( HOOT_PREMIUM_THEMEDIR ) . 'admin/shortcodes.php' ) )
				include_once( trailingslashit( HOOT_PREMIUM_THEMEDIR ) . 'admin/shortcodes.php' );

			// Get Core Shortcodes
			$shortcodes = require_once ( trailingslashit( HOOT_PREMIUM_EXTENSIONS ) . 'shortcodes/shortcodes.php' );
